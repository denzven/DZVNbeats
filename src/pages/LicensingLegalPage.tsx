      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-zinc-400 text-sm sm:text-base mt-4 leading-relaxed">
            Review detailed usage rights, deliverable audio formats, and legal
            agreement terms before acquiring your beat lease or exclusive
            rights.
          </p>
        </div>
                ...
                <div>
                  ...
                  <div className="space-y-3 text-xs text-zinc-300 border-t border-zinc-800/80 pt-6">
                    <div className="flex items-start gap-2.5">
                      ...
                      <span>
                        <strong>Audio Format:</strong> {tier.format}
                      </span>
                    </div>
                    ...
                    <div className="flex items-start gap-2.5">
                      <Check className="w-4 h-4 text-emerald-400 flex-shrink-0 mt-0.5" />
                      <span>
                        <strong>Audio Streams:</strong> {tier.streamLimit}
                      </span>
                    </div>
        ...
        <div className="mb-20 bg-zinc-900/40 border border-zinc-900 rounded-3xl p-8 md:p-12">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-white">
              Standard License Terms &amp; Conditions
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-xs text-zinc-400 leading-relaxed">
            <div className="space-y-3">
              ...
              <p>
                Purchasing a Basic Lease grants the licensee a non-exclusive
                right to record vocals, mix, and distribute the new song. The
                producer (DZVNbeats) retains copyright ownership of the
            ...
            <div className="space-y-3">
              ...
              <p>
                Upon purchasing Exclusive Rights, full master ownership and sole
                commercial exploitation rights transfer to the buyer. The beat
                will be immediately removed from the catalog and will not be
            ...
            <div className="space-y-3">
              ...
              <p>
                The Licensee must credit "Produced by DZVN" in all digital
                release metadata, liner notes, and video titles. Performance
                rights royalties are split 50/50 between Writer and Producer for
                non-exclusive leases unless negotiated otherwise.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p>
                All delivered files (MP3, WAV, or Stems) are completely untagged
                without audio voice tags. Download links and signed PDF
                contracts are issued immediately upon inquiry confirmation.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <div className="p-5 bg-zinc-900/30 border border-zinc-900 rounded-xl">
              ...
              <p className="text-xs text-zinc-400 leading-relaxed">
                If your song reaches the stream cap of your current lease (e.g.
                50k for Basic Lease), you simply upgrade to Exclusive Rights by
            ...
            <div className="p-5 bg-zinc-900/30 border border-zinc-900 rounded-xl">
              <h3 className="text-sm font-bold text-zinc-200 mb-1">
                Can I register my song with Content ID / YouTube ContentID?
              </h3>
              <p className="text-xs text-zinc-400 leading-relaxed">
                Non-exclusive leases cannot be registered with automated
                ContentID systems (to prevent false copyright strikes against
                other lease holders). ContentID registration is only permitted
            ...
            <div className="p-5 bg-zinc-900/30 border border-zinc-900 rounded-xl">
              <h3 className="text-sm font-bold text-zinc-200 mb-1">
                How fast do I receive beat files after inquiring?
              </h3>
              <p className="text-xs text-zinc-400 leading-relaxed">
                Inquiries are monitored 24/7. Once confirmed via Instagram DM or
                Email, custom direct download links and PDF contract agreements
                are sent within 2 to 4 hours.
              </p>
            </div>
          </div>
        </div>
